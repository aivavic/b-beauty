    ...
    <div id="header">
        <div class="div1">
            ...
            <div class="div3">
                ...
                <? if (isset($_SESSION['loguser']) && $_SESSION['loguser'] == 1) echo htmlspecialchars($_SESSION['loguserfio']); else echo 'admin'; ?>
                &nbsp;&nbsp;(<A
        ...
        <div id="menu">
			...
			<ul class="sub_menu">';
                    ...
                    if ($act == $temp1_act) {
                        ?>
                        <li class="selected"><a <? if ($temp1_url != '') echo ' href="' . $temp1_url . '" '; ?> "
                            class="top"><?= $temp1_title; ?></a>
                            <?= $subitems_html ?>
                        </li>
                        <?
                    } else {
                        ?>
                        <li><a <? if ($temp1_url != '') echo ' href="' . $temp1_url . '" '; ?>
                                    class="top"><?= $temp1_title; ?></a><?= $subitems_html ?></li>
                        <?
                    }
