...
//        include "modules/indexmodules_logic/brand_logic.php";
//        include "modules/indexmodules_logic/slider_logic.php";
//        include "modules/indexmodules/brands.php";
//        include "modules/indexmodules/slider.php";
	...
	if($act=="cat"  || $act=="bestsellers" || $act=="akcii")
	{
	   ...
	   // include "modules/indexmodules_logic/aside_logic.php";
...
(function (d, w, c) {
    (w[c] = w[c] || []).push(function() {
        try {
            w.yaCounter28154346 = new Ya.Metrika({id:28154346,
                    webvisor:true,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="//mc.yandex.ru/watch/28154346" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
